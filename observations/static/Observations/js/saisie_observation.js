...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let nomOcrOriginal = null;  // Nom lu depuis le JSON
    let nomSaisiCorrect = '';   // Nom saisi par l'utilisateur
    ...
    function ouvrirModalObservateur() {
        ...
        // Afficher la modale (le fond est integre dans le style)
    ...
    window.selectionnerObservateur = function(id, nom, nombreFiches) {
        ...
        // Afficher la modale de confirmation (le fond est integre dans le style)
    ...
    console.log('Module correction observateurs: initialisation terminee');
});

// ====================================
// Gestion de l'incertitude pour les champs numériques (5?)
// ====================================

(function initIncertitudeHandlers() {
    'use strict';
