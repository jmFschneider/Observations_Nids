 ...
 * Convertit un <select> standard en un champ de recherche avec autocomplétion
 * et filtrage local des options.
 */
export default function initSpeciesSearch() {
    'use strict';
    ...
    if (especeSelect) {
        ...
        console.log('Module Recherche Espèce initialisé');
    }
}
