...
urlpatterns = [
    ...
    path('finaliser/<int:importation_id>/', importation.finaliser_importation, name='finaliser_importation'),
    path('resume/', home.resume_importation, name='resume_importation'),

    # Réinitialisation
    path('reinitialiser/<int:importation_id>/', importation.reinitialiser_importation, name='reinitialiser_importation'),
    path('reinitialiser-toutes/', importation.reinitialiser_toutes_importations, name='reinitialiser_toutes_importations'),
]
