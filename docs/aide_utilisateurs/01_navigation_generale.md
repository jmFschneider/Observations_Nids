...
3. [Les différentes sections](#3-les-différentes-sections)
...
**Voir le guide détaillé** : [02_saisie_nouvelle_observation.md](./02_saisie_nouvelle_observation.md)
...
**Voir le guide détaillé** : [03_correction_transcription.md](./03_correction_transcription.md)
